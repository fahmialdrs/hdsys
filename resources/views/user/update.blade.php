...
<!-- 	<div class="container-fluid"> -->
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-6">
					<form method='POST' action="{{URL::route('user::update',['id'=>$data->id])}}" role='form'>
						{!! csrf_field() !!}
						<input type="hidden" name="_method" value="PUT">
						<input type="hidden" name='id' value='{{$data->id}}'>
						<div class="input-group col-md-12">
							<span class="input-group-addon" id="sizing-addon1"><i class='fa fa-user fa-fw'></i></span>
							<input class="form-control" type='text' placeholder='Username' name='name' value="{{ $data->name or '' }}"/>
						</div>
						<div class="height10"></div>
						<div class="input-group col-md-12">
							<span class="input-group-addon" id="sizing-addon1"><i class='fa fa-envelope fa-fw'></i></span>
							<input class="form-control" type='text' placeholder='Email' name='email' value="{{ $data->email or '' }}"/>
						</div>
						<div class="height10"></div>
						<div class="input-group col-md-12">
